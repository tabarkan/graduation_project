...
@if($disease->accepted == 1)
__________________________<br>
Name : {{$disease->disease_name}}<br>
Category : {{$disease->disease_category}}<br>
          ...
          <div class="row">
            @foreach ($diseases as $disease)
                <div onclick="window.location='{{route('user.show.disease', $disease->id)}}'" class="col-md-6 col-lg-4 py-3 wow zoomIn">
                    ...
                    <div class="body">
                        <p class="text-lg fw-bold mb-0"> {{$disease->disease_name}} </p>
                        <span class="text-sm text-grey">{{$disease->disease_category}}</span>
                    </div>
                    </div>
                </div>
            @endforeach
