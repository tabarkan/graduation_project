              ...
              <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                ...
                <li class="flex items-center">
                  <a href="../pages/sign-in.html" class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21q-.825 0-1.413-.588T3 19V5q0-.825.588-1.413T5 3h7v2H5v14h7v2H5Zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5l-5 5Z"/></svg>
                ...
                <li class="flex items-center px-4">
                  <a href=""  class="p-0 text-sm text-white transition-all ease-nav-brand">
                    <a href="{{route('admin.main')}}" class="p-0 text-sm text-white transition-all ease-nav-brand"><i fixed-plugin-button-nav class="cursor-pointer fa fa-cog"></i> </a>
                ...
                <li class="relative flex items-center pr-2">
                  ...
                  <a href="javascript:;" class="block p-0 text-sm text-white transition-all ease-nav-brand" dropdown-trigger aria-expanded="false">
                   <a href="{{route('notifications.list')}}" class="block p-0 text-sm text-white transition-all ease-nav-brand"> <i class="cursor-pointer fa fa-bell"></i> </a>
                  </a>
