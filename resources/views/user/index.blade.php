      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="{{asset('one-health/assets/img/doctors/doctor_1.jpg')}}" alt="">
              <div class="meta">
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="{{asset('one-health/assets/img/doctors/doctor_2.jpg')}}" alt="">
              <div class="meta">
                <a href="#"><span class="mai-call"></span></a>
                <a href="#"><span class="mai-logo-whatsapp"></span></a>
              </div>
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="{{asset('one-health/assets/img/doctors/doctor_3.jpg')}}" alt="">
              <div class="meta">
                <a href="#"><span class="mai-call"></span></a>
                <a href="#"><span class="mai-logo-whatsapp"></span></a>
              </div>
